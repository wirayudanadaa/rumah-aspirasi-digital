        ...
        <div className="bg-white rounded-3xl shadow-xl border border-[#90CAF9]/60 p-8 md:p-10 text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              Terima kasih. Laporan Anda telah tercatat pada sistem **Rumah Aspirasi Digital** dan akan segera diverifikasi oleh petugas instansi berwenang.
            </p>
          </div>
          ...
          <div className="bg-[#E3F2FD]/60 border border-[#90CAF9] rounded-2xl p-6">
            ...
            <div className="flex items-center justify-center gap-3">
              <span className="text-2xl md:text-3xl font-black text-[#1565C0] tracking-wider font-mono">{ticketNumber}</span>
              <button
                onClick={copyToClipboard}
                className="p-2.5 bg-white hover:bg-[#E3F2FD] rounded-xl text-[#1565C0] border border-[#90CAF9] transition-colors shadow-sm"
          ...
          <div className="text-xs text-slate-500 bg-slate-50 p-4 rounded-xl border border-slate-200 flex items-center justify-center gap-2">
